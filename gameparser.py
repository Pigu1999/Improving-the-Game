...
def normalise_input(user_input):
    ...
    no_punct_whitespaces = no_punct.strip()
    no_punct_whitespaces_list = no_punct_whitespaces.split()
    normalised_input = filter_words(no_punct_whitespaces_list, skip_words)
