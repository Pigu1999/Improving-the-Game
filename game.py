...
The aim of this oh so important game is to collect all the items from around Cardiff 
University's very own Queen's Building and deposit them at main reception.
Its not that easy tho cause you can't carry more than 3KG at once, so be
careful not to strain your back lifting heavy objects.
"""
        )
    while True:
        # Display game status (room description, inventory etc.)
        if len(rooms['Reception']['items']) == 6:
            print('Well done you have completed the game, good for you!!')
            break
        else:
